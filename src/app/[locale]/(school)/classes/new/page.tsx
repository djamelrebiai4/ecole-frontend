  ...
  return (
    <div>
      ...
      <form className="max-w-2xl space-y-6" onSubmit={handleSubmit}>
        {noAcademicYear && !loadingYear && (
          <div className="rounded-lg border border-yellow-300 bg-yellow-50 px-4 py-3 text-sm text-yellow-800">
            لا توجد سنة دراسية.
            {" "}
            <Link href="/academic-years/new" className="font-bold underline hover:text-yellow-900">
              أضف سنة دراسية أولاً
            </Link>
          </div>
        )}
        {error && (
        ...
        <div className="flex gap-2">
          <button type="submit" disabled={saving || loadingYear || noAcademicYear || !academicYearId}
